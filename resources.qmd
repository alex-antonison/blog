...
### Overview
 ...
 This is a list of resources that I keep in mind when trying to solve specific solutions around data. This is not meant to be a comprehensive list of all tools available for building data solutions! I also include some day-to-day tools I use to help manage things such projects, time, and communication. 
...
|Tool|Type|Purpose|
|--------|-------|----|
|<a href="https://black.readthedocs.io/en/stable/" target="_blank">black</a>|Clean Code|black is a python code formatter that helps keep code consistnly formatted across teams|
...
|<a href="https://aws-sdk-pandas.readthedocs.io/en/stable/" target="_blank">awswrangler</a>|AWS SDK|AWS Development|A package that streamlines developing data solutions in AWS|
