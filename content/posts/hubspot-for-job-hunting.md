...
![This is what my company view looks like with the fake company I set up for testing purposes.](/images/hubspot-companies-example.png)
...
![This is the custom Company Type field dropbox I created](/images/hubspot-company-type-dropdown.png)

![You get to Company > Type Edit property via Profile & Preferences > Data Management > Objects > Companies](/images/hubspot-company-field-properties.png)

![Once in the Type Object, you can customize the Types](/images/hubspot-company-type-edit.png)
...
![Contact Entry Form](/images/hubspot-contact-entry-form.png)

![This is what my contacts view looks like. I recommend adding yourself as a contact as you can try things out like e-mail, scheduling, etc.](/images/hubspot-contacts-example.png)
...
![HubSpot Identifies Contacts with duplicate e-mails](/images/hubspot-contact-data-quality.png)
...
![My initial pass at setting up the different stages of a job application process.](/images/hubspot-deals-to-job-applications.png)
...
![Job Application/Deal Entry Form](/images/hubspot-submit-job-application.png)
...
![This is what my HubSpot Deals view looks like](/images/hubspot-deals-view.png)
...
![My example contact showing what you can capture](/images/hubspot-contact-activities.png)
...
![Example logging an activity](/images/hubspot-logging-an-email.png)
