...
- Event: [Nashville Data Engineering Monthly Meetup](https://www.meetup.com/nashville-data-engineering-group/events/293775727/)
- Talk: [Deploying a Serverless Data Lake in AWS](https://onedrive.live.com/edit.aspx?resid=D430825279B24722!230089&ithint=file%2cpptx&authkey=!ACWXwRzgPzZggXk)
...
- Event: [SETAC North America Annual Meeting](https://pittsburgh.setac.org/)
- Talk: [The multi-sensor data system (MSDS): The strategy and execution of a user-friendly system that puts water quality data, from a variety of different manufacturers, in the hands of scientists](https://onedrive.live.com/view.aspx?resid=D430825279B24722!220652&ithint=file%2cpptx&authkey=!AI5mqBP8R_utXzo)
...
- Event: [Nashville Analytics Summit](https://www.theanalyticssummit.com/)
- Talk: [Strategy and execution of a multi-sensor data system](https://1drv.ms/p/s!AiJHsnlSgjDUjbttTTfApWTDeBncSQ?e=MnbZb7)
...
- Event: MTSU Computational and Data Science Seminar
- Talk: [Strategy and execution of a multi-sensor data system](https://1drv.ms/p/s!AiJHsnlSgjDUjbtw76fMLWT7YpGE-Q?e=aqeZB1)
...
- Event: [Nashville Data Nerds](https://www.meetup.com/data-nerds/)
- Talk: [A Nerdy Dive into Data Tools](https://docs.google.com/presentation/d/1VFzRmNI7essY6A5vRldiTcZQ-oDXorBB6kfVsEXUWQE/edit?usp=sharing)
